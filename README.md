...
用数学式子来表达：令i为第i个消费者，$i＝1，2，…，m$；$j，k$是分别代表第$j，k$种商品，$j，k＝1，2，…，n$，则对第i个消费者来说，消费均衡时有：$MRS^1_{jk}= \frac{P_j}{P_k}，j，k=l，2，…，n$。而$P_j$，$P_k$对所有的消费者都相同的，故有$MRS^1_{jk}= MRS^2_{jk}= ...= MRS^m_{jk}= \frac{P_j}{P_k}，j，k=1，2，…，n$。  
